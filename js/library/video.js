 ...
 */
import {version} from './video.js-main/package.json';
...
import {
  ...
  hookOnce,
  removeHook
} from './video.js-main/src/js/utils/hooks';
import * as setup from './video.js-main/src/js/setup';
import * as stylesheet from './video.js-main/src/js/utils/stylesheet.js';
import Component from './video.js-main/src/js/component';
import EventTarget from './video.js-main/src/js/event-target';
import * as Events from './video.js-main/src/js/utils/events.js';
import Player from './video.js-main/src/js/player';
import Plugin from './video.js-main/src/js/plugin';
import * as Fn from './video.js-main/src/js/utils/fn.js';
import * as Num from './video.js-main/src/js/utils/num.js';
import * as Str from './video.js-main/src/js/utils/str.js';
import TrackList from './video.js-main/src/js/tracks/track-list.js';
import TextTrack from './video.js-main/src/js/tracks/text-track.js';
import TextTrackList from './video.js-main/src/js/tracks/text-track-list.js';
import AudioTrack from './video.js-main/src/js/tracks/audio-track.js';
import AudioTrackList from './video.js-main/src/js/tracks/audio-track-list.js';
import VideoTrack from './video.js-main/src/js/tracks/video-track.js';
import VideoTrackList from './video.js-main/src/js/tracks/video-track-list.js';
import { deprecateForMajor } from './video.js-main/src/js/utils/deprecate';
import * as Time from './video.js-main/src/js/utils/time.js';
import log, { createLogger } from './video.js-main/src/js/utils/log.js';
import * as Dom from './video.js-main/src/js/utils/dom.js';
import * as browser from './video.js-main/src/js/utils/browser.js';
import * as Url from './video.js-main/src/js/utils/url.js';
import * as Obj from './video.js-main/src/js/utils/obj';
import VjsErrors from './video.js-main/src/js/consts/errors';
import xhr from '@videojs/xhr';

// Include the built-in techs
import Tech from './video.js-main/src/js/tech/tech.js';
import { use as middlewareUse, TERMINATOR } from './video.js-main/src/js/tech/middleware.js';
